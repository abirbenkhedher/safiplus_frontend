...
import { FaPlus, FaEdit, FaTrash, FaClipboardList, FaSearch, FaSave, FaTimes, FaCalendarAlt, FaSortNumericDown } from 'react-icons/fa';
...
const ObjetsCRUD = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingItem) {
        await updateObjet(editingItem._id, payload);
